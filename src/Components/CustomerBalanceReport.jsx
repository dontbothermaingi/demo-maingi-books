  ...
  const currencyOptions = [
    ...
    useEffect(()=>{
        ...
        .then(data => {
            ...
            const formatted = filter.map(item => ({
                ...item,
      ...
      useEffect(() => {
        ...
        const filtered = totals.filter(item => item.currency === selectedCurrency);
        const filteredCustomer = customers.filter(item => item.currency === selectedCurrency);
        setFilteredReceivables(filtered);
        setFilteredCustomers(filteredCustomer)
      }, [totals,customers, selectedCurrency]);
