...
function SpareBill() {
   ...
   const navigate = useNavigate()
    ...
    function handleNewInputField() {
        setNewItem ([...newItem, { item_details: "",spare_name:"" , unit:0, measurement:"", quantity: 0, rate: 0, vat: 0, rate_vat: 0,sub_total: 0 ,amount: 0 }]);
    }
    ...
    return (
        <Box margin={{xs:'20px', md:'40px'}}>
             ...
             <Box>
                ...
                >
                    <Typography fontFamily={"GT Medium"} fontSize={{xs:'25px', md:'27px'}} textAlign={'center'}>NEW SPARE BILL</Typography>
