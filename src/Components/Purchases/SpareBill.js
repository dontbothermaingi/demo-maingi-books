   ...
   const navigate = useNavigate()
    ...
    function handleNewItemChange(event) {
      ...
      function addItem() {
        ...
        setNewItem({ item_details: "",spare_name:"" , unit:0, measurement:"", quantity: 0, rate: 0, vat: 0, rate_vat: 0,sub_total: 0 ,amount: 0 });
    }
    ...
    function handleSubmit(event) {
        ...
        fetch('https://db-demo-u07o.onrender.com/sparebills', {
            method: "POST",
            headers: {
