...
import { Box, Button, Typography,IconButton, FormControl, MenuItem, Select, TextField, Divider, ListSubheader, Radio, RadioGroup, FormControlLabel, TableContainer, Table, TableHead, TableRow, TableCell, Snackbar, Alert, CircularProgress } from "@mui/material";
...
function BillFuel() {
   ...
   const navigate = useNavigate()
    ...
    function handleNewItemChange(event, index) {
        ...
        //Update base on the name of the field
    ...
    function handleSubmit(event) {
        ...
        fetch('https://maingi-demo-server.onrender.com/creditfuelbills', {
            method: "POST",
            headers: {
    ...
    return (
        <Box margin={{xs:'20px', md:'40px'}}>
             ...
             <Box>
                ...
                >
                    <Typography fontFamily={"GT Medium"} fontSize={{xs:'25px', md:'27px'}} textAlign={'center'}>NEW FUEL BILL</Typography>
                                        ...
                                        <Box>
                                            ...
                                            {activeItem === index && 
                                                <Box key={index} display={'flex'} gap={'20px'} flexDirection={'column'}>
                                                    ...
                                                    <Select name="item_details" value={item.item_details} className="bill-inputfield" onChange={(e) => handleNewItemChange(e, index)} fullWidth displayEmpty>
                                ...
                                <Box>
                                    <TableContainer>
                                        <Table>
                                            <TableHead>
                                                <TableRow>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">Vehicle</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">Litres</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">Rate</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">Sub Total</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">VAT</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 120 }}><Typography fontWeight="bold">VAT Amount</Typography></TableCell>
                                                    <TableCell sx={{ minWidth: 100 }}><Typography fontWeight="bold">Total Amount</Typography></TableCell>
