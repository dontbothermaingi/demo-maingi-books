                        ...
                        <Box>
                            ...
                            {isMobile ? (
                                            ...
                                            {activeItem === index &&
                                                <Box key={index} display={'flex'} gap={'20px'} flexDirection={'column'}>
                                                    ...
                                                    <Select name="item_details" value={item.item_details} className="bill-inputfield" onChange={(e) => handleNewItemChange(e, index)} fullWidth displayEmpty>
                                                        ...
                                                        {pumps.map((truck, index) => (
                                                            <MenuItem key={index} value={truck.pump_name}>{truck.pump_name}</MenuItem>
                                                        ))}
                                                    </Select>
                                ...
                                <Table>
                                    <TableHead>
                                        <TableRow>
                                            <TableCell sx={{ minWidth: 150 }}><Typography fontWeight="bold">Pump Name</Typography></TableCell>
                                            <TableCell sx={{ minWidth: 100 }}><Typography fontWeight="bold">Litres</Typography></TableCell>
