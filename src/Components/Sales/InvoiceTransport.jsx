    ...
    return (
        <div>
            <div className="invoice-content">
                ...
                <div>
                    <h2 className="h2">NEW TRANSPORT INVOICE</h2>
                        ...
                        <table className="invoice-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><input value={newItem.sub_total.toLocaleString()} onChange={handleNewItemChange}/> </td>
                                    <td>
                                    ...
                                    <td><input value={newItem.rate_vat.toLocaleString()} onChange={handleNewItemChange}/> </td>
                                    <td><input value={newItem.amount.toLocaleString()} onChange={handleNewItemChange}/> </td>
                                </tr>
                            </tbody>
                        </table>
                        </div>
