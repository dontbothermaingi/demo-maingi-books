import { useState } from "react";
 ...
 import {AccountBalanceWallet, Build, DonutLarge, Inventory, LogoutOutlined, PointOfSale } from "@mui/icons-material";
 import './Navbar.css';
 ...
 function SideBar({ onLogout }) {
     ...
     const renderNavLink = (to, label) => (
         <NavLink exact to={to} className="navlink" activeClassName="active">
             <Box display='flex' flexDirection='row' gap='10px' paddingLeft={"20px"}  alignItems='left'>
                 <Typography fontFamily={"GT Light"} variant="body2">{label}</Typography>
             </Box>
         </NavLink>
     );
             ...
             >
                 ...
                 <Box overflow={'auto'} >
                         ...
                         <Box >
                             ...
                             {activeDropdown === 'trucks' && (
                                 <Box mt={1}>
                                     ...
                                     {renderNavLink("/truck-invoices", "Fuel Report")}
                         ...
                         <Box >
                             ...
                             >
                                 <PointOfSale sx={{ marginRight: '10px' }} />
                                 SALES
                         ...
                         <Box >
                             ...
                             >
                                 <AccountBalanceWallet sx={{ marginRight: '10px' }} />
                                 BANKING
                         ...
                         <Box>
                             ...
                             >
                                 <DonutLarge sx={{ marginRight: '10px' }} />
                                 TYRES
